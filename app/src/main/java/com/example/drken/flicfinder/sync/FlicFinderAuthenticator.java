...
/**
 * Manages "Authentication" to FlicFinder's backend service.  The SyncAdapter framework
 ...
 */
public class FlicFinderAuthenticator extends AbstractAccountAuthenticator {

    public FlicFinderAuthenticator(Context context) {
        super(context);
    }
